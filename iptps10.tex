...
too much to make this approach unuseful.  Like the churn in the system,
this approach could benefit from having shared common, centralized resource
that lets users access their social overlays by proxy without connecting
their device directly to the overlay network.
...
complicated procedure.  Previous work has researched methods to keep overlays
working smoothly even while under attack.  For the social overlay to be
